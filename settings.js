...
global.owner = process.env.OWNER_NUMBER  || '940701908397' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=rI8VDBoD#Bun6ndWYVYxWPdc-T2X18pTAg3NKoHjl5Zh57RbMW38' ,
